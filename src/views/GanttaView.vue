...
export default {
  ...
  mounted() {
    ...
    const config = {
      licenseKey:
        '====BEGIN LICENSE KEY====\||U2FsdGVkX1++NgfKw9ZTc2GxiN59OZpBEHLKIneJ2V9v8n/UJ0sRuuXysXZTT3wz77eI2kfqeCj1HG+k/oh4D8R2Xgh0SVSv68kbCBEjUig=\\n====END LICENSE KEY====',
      plugins: [
        TimelinePointer(),
        Selection(),
        ItemResizing(),
